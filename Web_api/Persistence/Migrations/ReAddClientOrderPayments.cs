...
{
    public partial class ReAddClientOrderPayments : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientOrderPayments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientOrderPayments_ClientOrders_ClientOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientOrderPayments_ClientOrderId",
