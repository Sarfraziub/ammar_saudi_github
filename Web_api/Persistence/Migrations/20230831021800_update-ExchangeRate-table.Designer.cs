...
namespace Persistence.Migrations
{
    ...
    [Migration("20230831021800_update-ExchangeRate-table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.ActionTracking", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Domain.ActionTrackingHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.LinkGeneration", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.LinkGenerationValue", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.ActionTrackingHistory", b =>
                {
                    b.HasOne("Domain.ActionTracking", "ActionTracking")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.DbModel.ExchangeRate", b =>
                {
                    b.HasOne("Domain.DbModel.Currency", "FromCurrency")
                        .WithOne("FromCurrencyExchangeRate")
                        .HasForeignKey("Domain.DbModel.ExchangeRate", "FromCurrencyId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Domain.DbModel.Currency", "ToCurrency")
                        .WithOne("ToCurrencyExchangeRate")
                        .HasForeignKey("Domain.DbModel.ExchangeRate", "ToCurrencyId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.LinkGenerationValue", b =>
                {
                    b.HasOne("Domain.LinkGeneration", "LinkGeneration")
