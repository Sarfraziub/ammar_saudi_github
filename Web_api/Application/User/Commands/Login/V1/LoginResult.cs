...
public class GuestOrderVm : IMapFrom<ClientOrder>
{
    ...
    {
        profile.CreateMap<ClientOrder, GuestOrderVm>()
            ...
            .ForMember(d => d.LocationDescription,
                opts => opts.MapFrom(s => s.Location != null ? s.Location != null ? s.Location.Description : null : null))
            .ForMember(d => d.LocationArabicDescription,
                opts => opts.MapFrom(s => s.Location != null ? s.Location != null ? s.Location.ArabicDescription : null : null))
