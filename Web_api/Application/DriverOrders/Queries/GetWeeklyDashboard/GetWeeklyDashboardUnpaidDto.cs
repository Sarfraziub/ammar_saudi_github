...
public class GetWeeklyDashboardUnpaidDto : IMapFrom<ClientOrder>
{
	...
	{
		profile.CreateMap<ClientOrder, GetWeeklyDashboardUnpaidDto>()
			.ForMember(d => d.Total,
				opts =>
					opts.MapFrom(s =>
			...
			.ForMember(d => d.DayOfWeek,
				opts => opts.MapFrom(s => s.Created.DayOfWeek))
