...
namespace Application.Features.LinkGeneration.Query.GetLinkGenerationById
{
    public class GetLinkGenerationByUniqueIdResponse : IMapFrom<Domain.DbModel.LinkGeneration>
    {
        ...
        {
            profile.CreateMap<Domain.DbModel.LinkGeneration, GetLinkGenerationByUniqueIdResponse>();
