...
using Application.Features.PromotionalLink.Command.DeletePromotionalLink;
using Application.Features.PromotionalLink.Command.UpdatePromotionalLink;
using Application.Features.PromotionalLink.Queries.GetPromotionalLinkById;
...
{
    public class PromotionalLinkController : BaseController
    {

        [HttpPost]
        [Authorize(Roles = "Admin")]
        public async Task<ActionResult> Add([FromBody] AddPromotionalLinkCommand command)
        {
